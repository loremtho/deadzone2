...
public class InputManager : MonoBehaviour
{
    ...
    private ControlMannger playerControls;

    private void Awake() => playerControls = new ControlMannger();
    ...
    private Vector2 ScreenPosition() { return playerControls.Player.PrimaryPosition.ReadValue<Vector2>(); }
